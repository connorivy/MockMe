...
public class MockCallTracker
{
    ...
    //internal static TReturn? FindAndCallApplicableMemberMock<TOriginalArgCollection, TReturn>(
    //    IReadOnlyList<ArgBagWithMock<TOriginalArgCollection, TReturn>>? mockStore,
    //    List<TOriginalArgCollection> argStore,
    //    TOriginalArgCollection argCollection
    //)
    //{
    ...
    //            var localReturn = CallMemberMockBase<TOriginalArgCollection, TReturn>(
    //                argBag.Mock,
    //                argCollection,
    //                out bool retValIsUserConfigured
    //            );
    ...
    //internal static TReturn? CallMemberMockBase<TReturn>(
    //    IMockCallbackRetriever<Action>? mock,
    //    out bool retValIsUserConfigured
    //)
    //{
    ...
    //    foreach (Action callback in mock.GetCallbacksRegisteredBeforeReturnCall())
    //    {
    //        callback();
    //    }

    //    if (
    //        mock is IMockReturnCallRetriever<Func<TReturn>> mockWithReturn
    //        && mockWithReturn.GetReturnValue() is Func<TReturn> returnFunc
    //    )
    //    {
    ...
    //        //    : default;
    //        returnVal = returnFunc();
    //        retValIsUserConfigured = true;
    //    }

    //    foreach (Action callback in mock.GetCallbacksRegisteredAfterReturnCall())
    //    {
    //        callback();
    //    }
    ...
    //internal static TReturn? CallMemberMockBase<TOriginalArgCollection, TReturn>(
    ...
    //    foreach (
    //        Action<TOriginalArgCollection> callback in mock.GetCallbacksRegisteredBeforeReturnCall()
    //    )
    //    {
    //        callback(argCollection);
    //    }

    //    if (
    //        mock is IMockReturnCallRetriever<Func<TOriginalArgCollection, TReturn>> mockWithReturn
    //        && mockWithReturn.GetReturnValue() is Func<TOriginalArgCollection, TReturn> returnFunc
    //    )
    //    {
    //        //TReturnCall? returnFunc = mockWithReturn.GetReturnValue();
    //        //returnVal = returnFunc is not null
    //        //    ? returnCallFunc(argCollection, returnFunc)
    //        //    : default;
    //        returnVal = returnFunc(argCollection);
    //        retValIsUserConfigured = true;
    //    }

    //    foreach (
    //        Action<TOriginalArgCollection> callback in mock.GetCallbacksRegisteredAfterReturnCall()
    //    )
    //    {
    //        callback(argCollection);
    //    }
